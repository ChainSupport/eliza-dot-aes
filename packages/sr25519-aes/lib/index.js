...
exports.SR25519AES = void 0;
const common_1 = require("@eliza-dot-aes/common");
const sr25519 = __importStar(require("@scure/sr25519"));
...
const getPublicKeyAndPrivateKeyCallBack = async (seedOrprivateKey) => {
    const privateKey = sr25519.secretFromSeed(seedOrprivateKey);
    const publicKey = sr25519.getPublicKey(privateKey);
    return [publicKey, privateKey];
};
class SR25519AES extends common_1.CryptMessage {
